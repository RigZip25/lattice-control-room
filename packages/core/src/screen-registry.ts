...
export const productScreens: readonly ProductScreen[] = [
  ...
  { order: 16, key: "capital-allocator", route: "/capital-allocator", title: "Распределение капитала", figmaNodeId: "82:4", domain: "CAPITAL", linksTo: ["venture", "treasury", "campaigns"] },
  { order: 17, key: "learning-engine", route: "/learning", title: "Контур обучения и граф знаний", figmaNodeId: "83:4", domain: "INTELLIGENCE", linksTo: ["experiments", "markets", "content-factory"] },
